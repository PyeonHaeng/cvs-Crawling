...
def main():
    ...
    gs_addi = {"enable": True, "store": "GS25"}
    ...
    seven_eleven_addi = {"enable": True, "store": "7-ELEVEn"}
    ...
    mini_stop_addi = {"enable": True, "store": "MINISTOP"}
    ...
    emart24_addi = {"enable": True, "store": "emart24"}
    ...
    PushNotificationModule().send_push(
        title=f"{month}월 제품 업데이트",
        body=f"{month}월 제품 업데이트가 완료되었습니다!",
    )
